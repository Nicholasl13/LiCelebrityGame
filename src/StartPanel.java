...
public class StartPanel extends JPanel implements ActionListener {
  ...
  public StartPanel(CelebrityGame controllerRef) {
    ...
    celebrityClue = "Enter the clue for the celebrity (Keanu Reeves)";
    clueLabel = new JLabel(celebrityClue);

    answerField = new JTextField("Type celebrity here (Probably Keanu Reeves) (4 letters min)");
    clueField = new JTextField("Enter celebrity clue here (Maybe about Keanu Reeves) (10 letters min)");
